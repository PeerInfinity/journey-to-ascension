...
export declare const SAVE_VERSION = "Fork 1.13";
...
export declare const EFFECTS: {
    ...
    time_compression_scale_run: [PerkType, number][];
    time_compression_single_tick_run: [PerkType, number][];
};
export declare function getZoneSkipCreditPerk(): PerkType;
