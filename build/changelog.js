...
export const CHANGELOG = [
    {
        version: "Fork 1.4",
        date: "2026-07-03",
        changes: "- Added Show Spark per Reset (Settings, Game Mods): displays, under the Divine Spark button, the Spark a prestige would award averaged over this prestige's runs, plus the peak that average has reached since the last prestige<br>"
