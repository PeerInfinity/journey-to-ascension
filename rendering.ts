...
function setupAutomationControls() {
    ...
    const edit_priorities_button = createChildElement(automation_div, "button") as HTMLButtonElement;
    ...
    setupTooltip(edit_priorities_button, () => editing ? "Done editing" : "Edit priorities", () =>
